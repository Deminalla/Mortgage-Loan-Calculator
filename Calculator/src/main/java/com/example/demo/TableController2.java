...
public class TableController2 implements Initializable{
    ...
    @FXML
    public void saveData(int month, double loan, double interest, double monthly, double left_to_pay){
        if (month==1){
            savy.clear();
        }
        savy.add(monthly);
    ...
    void showChart(ActionEvent event) {
        try{
            ...
            //thirdContrl.printChart(listy, savy); //this line causes exception....
